-- Запрос для атрибуции 24 HOURS
-- Только данные с attribution_type = '24_hours'
-- 
-- Для использования:
-- 1. Создайте Dataset на основе этого запроса
-- 2. Создайте метрики в Superset (см. GOOGLE_SHEETS_METRICS_SETUP.md)
-- 3. Используйте в Chart для анализа данных с атрибуцией 24 часа
...
WHERE event_date IS NOT NULL
  ...
  AND attribution_type = '24_hours'  -- ТОЛЬКО 24 HOURS
GROUP BY 
    DATE(event_date),
    format,
    campaign_name,
