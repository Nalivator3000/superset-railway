...
SELECT 
    ...
    -- Показываем примеры последних символов в каждой группе
    STRING_AGG(DISTINCT LOWER(RIGHT(external_user_id, 1)), ', ' ORDER BY LOWER(RIGHT(external_user_id, 1))) as sample_chars
